...
Public Class frmReserve
    ...
    Private Sub display_reserve()
        ...
        For indx = 0 To Dt.Rows.Count - 1
            ...
            lv.SubItems.Add(Dt.Rows(indx).Item("ReservationDate"))
    ...
    Private Sub bttnReserve_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bttnReserve.Click
        ...
        If lblGuestID.Text = "GuestID" Or lblGuestID.Text = Nothing Or txtRoomNumber.Text = Nothing Or Val(children + adult) = 0 Or advance = Nothing Or discount = Nothing Then
